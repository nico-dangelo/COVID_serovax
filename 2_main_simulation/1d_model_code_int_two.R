...
COVID_sero_vax <- function(t, start, params){
  with(as.list(c(start,params)),{
    ...
    Nchildu = sum(Ncu0v0,Ncu1v0,Ncu2v0,Ncu0v1,Ncu1v1,Ncu2v1,Ncu0v2,Ncu1v2,Ncu2v2)
    Nadultu = sum(Nau0v0,Nau1v0,Nau2v0,Nau0v1,Nau1v1,Nau2v1,Nau0v2,Nau1v2,Nau2v2)
    Noldu   = sum(Neu0v0,Neu1v0,Neu2v0,Neu0v1,Neu1v1,Neu2v1,Neu0v2,Neu1v2,Neu2v2)
    
    ## Vax values (0 unless triggered)
    
    ## Vax values (0 unless triggered)
    
     delta1_cu<-0;  delta1_au<-0;  delta1_eu <-0   
   delta2_cu<-0; delta2_au<-0; delta2_eu <-0   
    ...
    foi_cu_0v0 = beta_c * (  #second part is urban infectious -> urban susceptible
    ...
    res = c(dScr0v0, dScu0v0, dSar0v0, dSau0v0, dSer0v0, dSeu0v0,
            ...
            dW1Rpcr1v0, dW2Rpcr1v0, 
            dW1Rpcu1v0, dW2Rpcu1v0,
            dW1Rpar1v0, dW2Rpar1v0, 
            dW1Rpau1v0, dW2Rpau1v0, 
            dW1Rper1v0, dW2Rper1v0, 
            dW1Rpeu1v0, dW2Rpeu1v0,
            ...
            dW1Vpcr0v1,dW2Vpcr0v1, 
            dW1Vpcu0v1,dW2Vpcu0v1, 
            dW1Vpar0v1,dW2Vpar0v1,
            dW1Vpau0v1,dW2Vpau0v1,
            dW1Vper0v1,dW2Vper0v1,
            dW1Vpeu0v1,dW2Vpeu0v1)
    
    time_varying_pars=c('foi_cu_0v0'=foi_cu_0v0, 'foi_au_0v0'=foi_au_0v0, 'foi_eu_0v0'=foi_eu_0v0,
                         'foi_cu_0v1'=foi_cu_0v1,  'foi_au_0v1'= foi_au_0v1,  'foi_eu_0v1'=foi_eu_0v1,
                        'foi_cu_0v2'=foi_cu_0v2,  'foi_au_0v2'= foi_au_0v2,  'foi_eu_0v2'=foi_eu_0v2,
                        
                        
                         'foi_cu_1v0'=foi_cu_1v0,  'foi_au_1v0'=foi_au_1v0,  'foi_eu_1v0'=foi_eu_1v0,
                         'foi_cu_1v1'=foi_cu_1v1,  'foi_au_1v1'= foi_au_1v1,  'foi_eu_1v1'=foi_eu_1v1,
                       'foi_cu_1v2'=foi_cu_1v2,  'foi_au_1v2'= foi_au_1v2,  'foi_eu_1v2'=foi_eu_1v2,
                        
                        
                        'foi_cu_2v0'=foi_cu_2v0,  'foi_au_2v0'=foi_au_2v0,  'foi_eu_2v0'=foi_eu_2v0,
                     'foi_cu_2v1'=foi_cu_2v1,  'foi_au_2v1'= foi_au_2v1,  'foi_eu_2v1'=foi_eu_2v1,
                    'foi_cu_2v2'=foi_cu_2v2,  'foi_au_2v2'= foi_au_2v2,  'foi_eu_2v2'=foi_eu_2v2,
